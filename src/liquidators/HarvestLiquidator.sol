...
contract HarvestLiquidator is IRedemptionStrategy {
     ...
     */
    IERC20Upgradeable public constant FARM =
        IERC20Upgradeable(0xa0246c9032bC3A600820415aE600c6388619A14D);

    /**
     * @dev iFARM ERC20 token contract.
     */
    IFarmVault public constant IFARM =
        IFarmVault(0x1571eD0bed4D987fe2b498DdBaE7DFA19519F651);
