...
const main = async () => {
  ...
  if (parsedArgs.flags) {
    ...
    switch (command) {
      ...
      // npm run scripts:poke -- -f getComptrollersImplementationOfPools
      case "getComptrollersImplementationOfPools":
        console.log(await fuse.getComptrollersImplementationOfPools());
        break;
